...
import { a as useRequestEvent } from "./cookie-C__dP6IS.js";
import "destr";
import "klona";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-BokXE656.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BMIO1miJ.js.map
