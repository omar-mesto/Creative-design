...
declare module 'nitropack' {
  ...
  interface InternalApi {
    ...
    '/api/home': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/home.get').default>>>>
    }
    '/api/store/products': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/store/products.get').default>>>>
    }
    '/__nuxt_error': {
    ...
    '/api/_content/cache.1712600353457.json': {
