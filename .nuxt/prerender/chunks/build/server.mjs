import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineComponent, provide, createElementBlock, defineAsyncComponent, h, onUnmounted, shallowRef, computed, unref, shallowReactive, Suspense, nextTick, Transition, Fragment, mergeProps, useSSRContext, createApp, effectScope, reactive, markRaw, isRef, isReactive, toRef, toRaw, getCurrentScope, onScopeDispose, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, isReadonly, toRefs, Text, isShallow, withCtx } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/ofetch/dist/node.mjs';
...
import { createError as createError$1, sanitizeStatusCode } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/h3/dist/index.mjs';
import { getActiveHead } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/vue-router/dist/vue-router.node.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, isSamePath } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/ufo/dist/index.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/defu/dist/defu.mjs';
import { setupDevtoolsPlugin } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/vue-devtools-stub/dist/index.mjs';
import { CoreWarnCodes, CoreErrorCodes, DEFAULT_LOCALE, registerMessageCompiler, compile, registerMessageResolver, resolveValue, registerLocaleFallbacker, fallbackWithLocaleChain, setDevToolsHook, createCompileError, updateFallbackLocale, NUMBER_FORMAT_OPTIONS_KEYS, DATETIME_FORMAT_OPTIONS_KEYS, setFallbackContext, createCoreContext, clearDateTimeFormat, clearNumberFormat, setAdditionalMeta, getFallbackContext, NOT_REOSLVED, isTranslateFallbackWarn, isTranslateMissingWarn, parseTranslateArgs, translate, MISSING_RESOLVE_VALUE, parseDateTimeArgs, datetime, parseNumberArgs, number, isMessageAST, isMessageFunction } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/@intlify/core-base/dist/core-base.mjs';
import { parse, serialize } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/cookie-es/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file://C:/Users/Omar/Desktop/creaticve%20Design/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CCnAYE_w.mjs').then((m) => m.default || m)
  },
  {
    name: "index___id",
    path: "/id",
...
const namedMiddleware = {
  auth: () => import('./auth-JJfE2iPs.mjs'),
  guest: () => import('./guest-BHgcMoo4.mjs')
};
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-D54jnrMe.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-DjB30PKk.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-CLx8sUxG.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-D0TSdmWI.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-DAStsMSV.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-DboR_xAK.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-pTmlp-wa.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-Jtdbvb92.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-B0teryc4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BqxRmJkn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-DYOy3nXX.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-DRsoFAzD.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DBRgDwwI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-CR1-Ipqp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-CVAEg1Jk.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-Detx7Bdz.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-C23R6TRn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-DaMbD3BG.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-DDRzi-H-.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-CkWjw8O-.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-Cop7n_Vg.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-8W3a4qPp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-BR8dL_kI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-QSf1_SNG.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-BD6u8akT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-CXNudQVh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-CM6beopQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-BCzDgEu3.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-BmQwuEYY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-BnfNJTRW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-Bkf88lry.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import('./Icon-2eSNtphF.mjs').then((r) => r["default"] || r.default || r));
...
function createComposer(options = {}, VueI18nLegacy) {
  ...
  const wrapWithDeps = (fn, argumentParser, warnType, fallbackSuccess, fallbackFail, successCondition) => {
    ...
    let ret;
    try {
      if ("prerender" !== "production" || __INTLIFY_PROD_DEVTOOLS__) {
...
function U(e) {
  return e != null && !("__composer" in e) && isRef(e.locale);
}
function $(e) {
...
function ze(e, { locales: t = [], localeCodes: o = [], baseUrl: n = fe, hooks: a = {} } = {}) {
  const l = effectScope(), c = e.install;
...
function Me(e, t) {
  const { locales: o, localeCodes: n, baseUrl: a } = t, l = ref(o), c = ref(n);
  e.locales = computed(() => l.value), e.localeCodes = computed(() => c.value), e.__baseUrl = je(a, {}), t.hooks && t.hooks.onExtendComposer && t.hooks.onExtendComposer(e);
}
function Xe(e, t, o) {
  const n = [
    {
...
function I(e) {
  const t = this.router, { routesNameSeparator: o } = B(t, this), n = e != null ? isRef(e) ? unref(e) : e : this.route;
...
const resolveNuxtI18nOptions = async (context) => {
  ...
  const vueI18nOptionsLoader = async (context2) => Object({ "legacy": false, "locale": "en", "messages": Object({ "en": {
    "app_name": (ctx) => {
      ...
      return _normalize(["Creative Design"]);
    }
  } }) });
...
const plugin_vyNBGOI7EC = /* @__PURE__ */ defineNuxtPlugin(async (nuxt) => {
  let __temp, __restore;
  const router = useRouter();
...
const layouts = {
  auth: () => import('./auth-Ciuu8NKA.mjs').then((m) => m.default || m),
  dashboard: () => import('./dashboard-BIp3yefC.mjs').then((m) => m.default || m),
  default: () => import('./default-B17VWAG7.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-OkpPH0M-.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Uh2KbPea.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRouter as a, defineStore as b, useRoute as c, defineNuxtRouteMiddleware as d, entry$1 as default, useRuntimeConfig as e, asyncDataDefaults as f, useNuxtApp as g, createError as h, navigateTo as i, __nuxt_component_0 as j, useI18n as k, nuxtLinkDefaults as n, useHead as u };
